...
export function ChatBot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div className={`fixed bottom-6 right-6 z-50 w-80 h-96 bg-white rounded-2xl shadow-2xl border border-gray-200 transition-all duration-300 flex flex-col ${
        isOpen ? 'scale-100 opacity-100' : 'scale-0 opacity-0'
      }`}>
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-slate-700 text-white rounded-t-2xl">
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-slate-500 focus:border-transparent bg-gray-50 text-gray-900 text-sm"
              disabled={isTyping}
            />
            <button
